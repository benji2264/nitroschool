...
<html>
  <meta charset="UTF-8">
    ...
    <?php
      ...
      $sql = "SELECT * FROM `eleves2` ORDER BY $choix_affichage";
    ...
    <form action="rechercher_eleve.php" method="post">
      ...
      <a class="buttontri" style="margin-left:27%;background-color:#858585;" href="liste_eleves.php">Défaut <img src="images/triangle.png" alt=""></a>
      <a class="buttontri" href="liste_eleves.php?tri=nom">Tri par nom <img src="images/triangle.png" alt=""></a>
      <a class="buttontri" href="liste_eleves.php?tri=prenom">Tri par prenom <img src="images/triangle.png" alt=""></a>
      <a class="buttontri" href="liste_eleves.php?tri=date_naissance">Tri par âge <img src="images/triangle.png" alt=""></a>

      <!-- Champ de recherche de l'élève, bouton loupe pour submit le form -->
      <input required type="search" style="text-align:left;width:210px;background-color:#008ef2;" placeholder="Recherche..." class="buttonsearch" name="eleve">
      ...
      <form method="post" action="consultation_eleve.php" style="margin: 0; padding:0;">
        <?php
          ...
          if (!($row = $result->fetch_array())) {
            echo "<tr><td></td><td></td><td>Aucun élève</td><td></td><td></td><td></td></tr>";
          }
          mysqli_close($conn);
       ?>
     </form>
