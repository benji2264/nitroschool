...
<html>
  <meta charset="UTF-8">
    ...
    <?php
      ...
      // On récupère les attributs de la séance
      $date_seance = $_POST['date'];
      $eff=$_POST['eff'];
      $theme=$_POST['theme'];

      // Les vérifications ayant déjà été faites dans ajout_seance.php, on ajoute juste la séance dans la BDD
      $query = "insert into seances2 values (NULL, '$date_seance', '$eff', '$theme')";
    ...
    <div class="formulaire" style="margin: 2% 35% 0%;height:720px;padding:10px">
          ...
          <form style="font-family:'Roboto', sans-serif;font-size:1.5rem;margin-left:60px; margin-right:60px;" class="" action="ajout_seance.php" method="post">
            ...
            <input type="date" id="date" name="date" required minlength="1"><br>
            <hr class="underrule">
