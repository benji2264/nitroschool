...
<html>
  <meta charset="UTF-8">
    ...
    <!-- Formulaire de désinscription d'un élève à une séance -->
    <div class="formulaire" style="height:475px;padding:10px">
        <div class="inscription" style="  margin-top:1%">
          <img height="70px" style="padding:0px;margin-left:3.5%" src="images/iconscription.png" alt="icon">
          <h3 style="font-size:3.5rem;text-align:center;color: #333"> Désinscrire</h3>
        </div>
        <form style="font-family: 'Roboto', sans-serif;font-size:1.5rem;margin-left:60px; margin-right:60px;" class="" action="verifier_desinscription2.php" method="post"><br>
          <label for="eleve">Elève à désinscrire</label><br>
          <?php
            //Connexion
          ...
          <select name="eleve" class="custom-select" style="width:95%;margin-top:20px;text-decoration:none;background-color:white;border:none;" required>
              ...
              <?php
                ...
                // On récupère et affiche l'ID, le nom et le prénom de chaque élève
